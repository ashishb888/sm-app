(function() {
  ...
  SProfilesCtrl.$inject = ['starterConfig', 'utilService', '$state', '$ionicPopup', 'lsService', '$scope', '$ionicModal', 'cameraService', '$stateParams', 'profileService'];

  function SProfilesCtrl(sConfig, utilService, $state, $ionicPopup, lsService, $scope, $ionicModal, cameraService, $stateParams, profileService) {
